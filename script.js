...
const elementsToObserve = document.querySelectorAll('.problem-card, .feature-item, .pricing-card');
            ...
            statNumbers.forEach(stat => {
                ...
                if (!isNaN(number)) {
                    ...
                    setTimeout(() => {
                        ...
                        // Add back any suffix (like %, h, etc.)
...
console.log('Green Care website loaded successfully! 🌱');
